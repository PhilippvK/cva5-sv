...
module instruction_metadata_and_id_management_vanilla
    ...
    always_ff @ (posedge clk) begin
        ...
        else if (gc.fetch_flush | scaiev.issue_flush) begin
    ...
    always_ff @ (posedge clk) begin
        ...
        else if (scaiev.decode_flush) begin
            pc_id <= oldest_pre_decode_id;
            fetch_id <= oldest_pre_decode_id;
            decode_id <= oldest_pre_decode_id;
        end
        else begin
    ...
    always_comb begin
        pre_issue_count_next = pre_issue_count + ID_COUNTER_W'(pc_id_assigned) - ID_COUNTER_W'(instruction_issued);
